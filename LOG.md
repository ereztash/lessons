...
| Portfolio size (actual) | **~40 repos** via `list_repos`, not 30; 9 never scanned incl. `pre-call` (active today) | 2026-08-19 |
...
| Repo-name collision | `groundstate-protocol` ≠ `ground-state-protocol` — different repos, plus 2 more copies | 2026-08-19 |
