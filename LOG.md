...
| **Known limit of every measurement here** | all scored on artifacts this operator produced. **Cross-family raters now run** (`ground-truth/interrater-2026-08-19.md`); a public corpus is still missing | 2026-08-19 |
| Pattern strengths | **reproducible across families** — 3 raters agree at ICC **+0.801**; adding the incumbent drops it to +0.652. **The incumbent is the outlier**, with a measured polarising bias | 2026-08-19 |
...
| Promoted cross-repo patterns | **34** (33 + programmatic-branch-naming, promoted by blind raters) | 2026-08-19 |
