...
| **Ground-state family resolved**: 4 repos, one root commit, **3 byte-identical at HEAD**. The live one is public `groundstate-protocol` (311 commits, 17d) — not the 67-commit copy this session measured | cohort2 §5 |
