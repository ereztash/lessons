...
> | Question | Answer |
> |---|---|
> | What is this? | [`docs/REFOUNDATION_DECISION.md`](docs/REFOUNDATION_DECISION.md) |
> | Which document answers what? | [`docs/AUTHORITY_MAP.md`](docs/AUTHORITY_MAP.md) |
...
> ([`research/re-foundation/CONTRADICTIONS.md`](research/re-foundation/CONTRADICTIONS.md) §3–§4):
> the portfolio is **40** repositories, not 25; the last content commit is **2026-08-19**, not
> 2026-05-13; and the four-feature classifier was measured on 2026-08-19 at **20% exact agreement,
> over-rating 8 of 10 repositories**.
