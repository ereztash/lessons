...
**Source observations**: cor-sys@10:04 (every Claude contribution carried `Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>` from commit one; flipped to direct `Claude <noreply@anthropic.com>` authorship on 2026-04-03); groundstate-protocol@11:00 (Claude direct from `dc90fee` onward — **note 2026-08-19: this "no co-authored phase" reading described only the early commits; the repo carries 76 Claude trailers across 4 model versions at 194 non-merge commits**); chess-mind-patterns@11:05 (all 3 human commits carry `Co-Authored-By: Claude Sonnet 4.6` trailer 11 days before cor-sys made it standard)
