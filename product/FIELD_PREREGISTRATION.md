...
| **P3** | projects that **paid**, with money received, not agreed | **≥ 3 of 5** | pre-call D4: *"without enforcement it is not a sale, it is an agreement."* Reality level **R6** |
...
| **P6** | analyst hours per project, median | **≤ 20** | at 20 hours a fixed-fee audit is viable at the rate this ICP pays a senior engineer. **Set, not derived** |
